---
title: "Websites I Love: Bookshelf Town"
date: 2025-10-28
tags: [books, design, indie-web]
---

I've been wanting to make a blog for a while but the minute I finished building the site I got shy and didn't know what to post so this is me trying to be better about posting, starting with a series: sharing websites I love.  
...
It has an endearingly simplistic yet clever design with the homepage being a book itself with bookmark-shaped tabs to navigate the site. Signing up is easy, and the personal page is split into columns of books you can add, organized in the typical "To Read," "Reading," and "Read," except each list is formatted to appear as a stack of book spines with the titles facing the viewer. I love that you can customize with different color themes (my favorite is 'tulip'), filter through books, and archive the ones you don't immediately want to view. 

I also didn't realize it until I started adding books myself, but I do appreciate the decision to exclude book covers (no matter how much I love looking at them individually), mainly because it prevents me from getting distracted or overwhelmed when scrolling through my or other people's lists. 

In an effort to not make this sound too much like an ad, I do have some issues with the site — currently, I can only see the books I've finished for the single year that I've specified in my settings with no option to see all the books I've completed regardless of the year. It's not a necessary function, but it would be nice to add. 

Also, when adding a book, you're searching through their database of books already populated by other readers, which isn't a problem except that there's no standard for naming titles or authors and no method for validating input, so you get results like this:
